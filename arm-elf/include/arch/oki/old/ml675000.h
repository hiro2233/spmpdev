...
#define ML675000_h
/*******************************************************************************
ML675000 - Register defs for OKI ML675001, ML67Q5002, ML67Q5003
...
#define CON              (REG32 (CACHE_BASE+0x04)) /* Cache control register */
#define CACHE            (REG32 (CACHE_BASE+0x08)) /* Cachable register */
#define FLUSH            (REG32 (CACHE_BASE+0x1C)) /* FLUSH register */
