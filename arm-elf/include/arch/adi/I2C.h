...
#define I2CDIVH	 	(*(volatile unsigned long *) 	0XFFFF0830)
#define I2CDIVL	 	(*(volatile unsigned long *) 	0XFFFF0834)
...
#define I2C0DIVH 	(*(volatile unsigned long *) 	0XFFFF0830)
#define I2C0DIVL 	(*(volatile unsigned long *) 	0XFFFF0834)
...
#define I2C1DIVH 	(*(volatile unsigned long *) 	0XFFFF0830)
#define I2C1DIVL 	(*(volatile unsigned long *) 	0XFFFF0834)
