#ifndef CYGONCE_HAL_ARM_ARM9_SPMP8K_PLF_IO_H
#define CYGONCE_HAL_ARM_ARM9_SPMP8K_PLF_IO_H
...
#include <cyg/hal/spmp8k.h>

#define CYGARC_PHYSICAL_ADDRESS(x) (x)

#endif // CYGONCE_HAL_ARM_ARM9_PMP8K_PLF_IO_H
// EOF plf_io.h
