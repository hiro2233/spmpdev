#ifndef CYGONCE_SPMP8K_H
#define CYGONCE_SPMP8K_H
...
// Date:         2003-08-01
// Purpose:      SPMP8K platform specific support definitions
// Description: 
...
#include <pkgconf/hal_arm_arm9_spmp8k.h>

// Memory layout details needed by conversion macro
#define SPMP8K_SDRAM_PHYS_BASE         0x30000000
#define SPMP8K_SDRAM_VIRT_BASE         0x00000000

#define SPMP8K_FLASH_PHYS_BASE         0x00000000
#define SPMP8K_FLASH_VIRT_BASE         0x80000000


// Internal clocks
#define FCLK CYGNUM_HAL_ARM_SPMP8K_CPU_CLOCK
#define HCLK CYGNUM_HAL_ARM_SPMP8K_BUS_CLOCK
#define PCLK CYGNUM_HAL_ARM_SPMP8K_PERIPHERAL_CLOCK
...
#define INTOFFSET  0x90010000  //Os//Interrupt request source offset
